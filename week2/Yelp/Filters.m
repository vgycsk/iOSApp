...
- (id) initAllFilters {
    ...
    if (self) {
        ...
        [self.allContents setValue:[self sortTypes] forKey:self.allFilters[0]];
        [self.allContents setValue:[self radiusTypes] forKey:self.allFilters[1]];
        [self.allContents setValue: [self dealTypes ] forKey:self.allFilters[2]];
        [self.allContents setValue:[self categoryTypes] forKey:self.allFilters[3]];
